...
<h2 class="text-center mt-4 mx-auto">Sales History </h2>
<div class="container w-50 my-4">
    <div class="btn-wrap d-flex flex-row-reverse">
        <a href="./" class="btn btn-secondary btn-sm mx-2">Show Books</a>
        <a href="customer" class="btn btn-primary btn-sm">Show Customers</a>
    </div>
    <table class="table">
        <thead>
        <tr>
